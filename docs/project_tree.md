...
**Capacity & Managment:** This sub-folder houses the Existing Capacity output from BRAT which estimates the landscapes ability to support beaver dam building activity. The folder also contains the "Channel Spanning Structures Appropriate" layer which also comes from BRAT. 
